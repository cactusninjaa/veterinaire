...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Apointement::class, mappedBy: 'assistant')]
    ...
    public function removeApointement(Apointement $apointement): static
    {
        if ($this->apointements->removeElement($apointement)) {
            // set the owning side to null (unless already changed)
            if ($apointement->getAssistant() === $this) {
                $apointement->setAssistant(null);
            }
        }
