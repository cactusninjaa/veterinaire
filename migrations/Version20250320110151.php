...
final class Version20250320110151 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE apointement (id INT AUTO_INCREMENT NOT NULL, animal_id INT NOT NULL, assistant_id INT NOT NULL, veterinarian_id INT NOT NULL, created_date DATETIME NOT NULL, apointement_date DATETIME NOT NULL, reason LONGTEXT NOT NULL, status JSON NOT NULL COMMENT \'(DC2Type:json)\', INDEX IDX_7144DD228E962C16 (animal_id), INDEX IDX_7144DD22E05387EF (assistant_id), INDEX IDX_7144DD22804C8213 (veterinarian_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE apointement_treatment (apointement_id INT NOT NULL, treatment_id INT NOT NULL, INDEX IDX_9CB5FF2718AF6914 (apointement_id), INDEX IDX_9CB5FF27471C0366 (treatment_id), PRIMARY KEY(apointement_id, treatment_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
